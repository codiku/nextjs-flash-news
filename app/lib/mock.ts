...
export const FAKE_ARTICLE_BY_CATEGORIES: { [key: string]: Article[] } = {
  business: [
    {
      ...
      content: "In this article, we delve into the intricacies of the business world, exploring the dynamics of finance and the global economy. We discuss the latest trends and provide an in-depth analysis of recent developments",
  ...
  environment: [
    ...
    },
    {
      ...
      content: "Our environment is a complex web of interdependent systems, each playing a crucial role in maintaining the balance of life on Earth. Deforestation, pollution, and climate change are posing significant threats to this delicate balance. However, the rise of sustainable practices and green technologies offers a beacon of hope. From recycling initiatives to the adoption of renewable energy sources, individuals and organizations are taking steps to reduce their environmental footprint. The journey towards a sustainable future is challenging, but every small step counts. Stay tuned for more updates on environmental conservation.",
  ...
  technology: [
    ...
    },
    {
      ...
      content: "Last month one of our journalists received an interesting email. A researcher had come across mention of a Guardian article, written by the journalist on a specific subject from a few years before. But the piece was proving elusive on our website and in search. Had the headline perhaps been changed since it was launched? Had it been removed intentionally from the website because of a problem we’d identified? Or had we been forced to take it down by the subject of the piece through legal means?",
